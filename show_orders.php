...
");
    ...
    foreach ($orders as $order) {
        ...
        $equipementTotal = $order['equipement_prix'] * $order['quantite'];
        $groupedOrders[$orderId]['total'] += $equipementTotal;  // Ajouter au total de la commande
    ...
    if (count($orders) > 0) {
        ...
        foreach ($groupedOrders as $order) {
            ...
            echo "<td>" . $order['total'] . " $</td>";  // Utiliser le total calculé pour chaque commande
            echo "<td>";
